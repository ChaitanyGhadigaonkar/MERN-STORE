...
const ProductModal = ({ product }) => {
    ...
    useEffect(() => {
        setProductData({ name: product.name, slug: product.slug, brand: "", price: product.price, category: product.category, size: product.size, description: product.description })
    }, [])
